...
benchmark number has a JSON receipt at `logs/demo/results_2026_05_28/`
that you can verify on your own hardware via the Streamlit demo
(`streamlit run code/demo/app.py`). The Rust source is auditable, the
algorithm is the published Norouzi-Punjani-Fleet 2012 multi-index
hashing, and 33 unit tests + integration checks against a Python
reference implementation cover correctness.
